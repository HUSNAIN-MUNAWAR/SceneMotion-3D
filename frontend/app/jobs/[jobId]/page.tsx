  ...
  useEffect(() => {
    const id = setInterval(async () => {
      ...
      if (currentJob.status === 'completed') {
        try {
          setMetrics(await getMetrics(jobId));
        } catch {}
      }
    }, 1200);
